...
struct ImGuiListClipperRange
{
    int     Min;
    int     Max;
    bool    PosToIndexConvert;      // Begin/End are absolute position (will be converted to mIndices later)
    ImS8    PosToIndexOffsetMin;    // Add to Min after converting to mIndices
    ImS8    PosToIndexOffsetMax;    // Add to Min after converting to mIndices
...
//#endif
    ...
    // Shade functions (write over already created mVertices)
