...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            // UV coordinates are often (0.0f, 0.0f) and (1.0f, 1.0f) to display an entire mTextures.
    ...
    if (ImGui::TreeNode("Plotting"))
    {
        ...
        // FIXME: This is rather awkward because current plot API only pass in mIndices.
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            // A typical application wanting coarse clipping and filtering may want to pre-compute an array of mIndices
